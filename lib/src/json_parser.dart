...
Map<String, dynamic> insomniaCollectionFromJsonStr(String str) {
  var rawInsomniajson = json.decode(str);
  // Remove all resources which are not requests
  rawInsomniajson['resources'] = (rawInsomniajson['resources'] as List)
    .where((resource) => resource['_type'] == 'request')
    .toList();

  print(rawInsomniajson['resources'].toList().length);


  return rawInsomniajson;
}
